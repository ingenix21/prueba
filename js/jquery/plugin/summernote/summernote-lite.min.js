...
!function(t, e) {
    ...
    function t(e, t) {
      ...
      "manual" !== this.options.trigger) {
        ...
        this.options.trigger.split(" ").forEach(function(t) {
          ...
          e.on("mouseenter", o).on("mouseleave", n)) : "click" === t ? e.on("click", i) : "focus" === t && e.on("focus", o).on("blur", n)
        })
      }
    }
  ...
  var n = function() {
    ...
    return t.prototype.show = function() {
      "body" === this.options.target ? (this.$backdrop.css("position", "fixed"),
      this.$modal.css("position", "fixed")) : (this.$backdrop.css("position", "absolute"),
    ...
    e && e.data && "dropdown" === e.data.toggle && t.data("_lite_dropdown", new o(t,{
      container: e.container
    }))
  })
    , m = t('<div class="note-dropdown-menu" role="list">', function(t, i) {
    var e = $.isArray(i.items) ? i.items.map(function(t) {
    ...
    var e = $.isArray(i.items) ? i.items.map(function(t) {
      var e = "string" == typeof t ? t : t.value || ""
        , o = i.template ? i.template(t) : t
        , n = $('<a class="note-dropdown-item" href="#" data-value="' + e + '" role="listitem" aria-label="' + t + '"></a>');
      return n.html([w(i.checkClassName), " ", o]).data("item", t),
      n
    }) : i.items;
    t.html(e).attr({
      "aria-label": i.title
      ...
      return h([f({
        ...
        callback: function(t) {
          t.find(".note-dimension-picker-mousecatcher").css({
            ...
            !function(t, e, o) {
              var n, i = $(t.target.parentNode), r = i.next(), s = i.find(".note-dimension-picker-mousecatcher"), a = i.find(".note-dimension-picker-highlighted"), l = i.find(".note-dimension-picker-unhighlighted");
              if (void 0 === t.offsetX) {
      ...
      return h({
        ...
        children: [f({
          ...
          callback: function(t) {
            ...
            "foreColor" !== d && (e.css("background-color", "#FFFF00"),
          ...
          callback: function(t) {
            ...
            "fore" === d ? (t.find(".btn-background-color").hide(),
            t.css({
              "min-width": "210px"
            })) : "back" === d && (t.find(".btn-foreground-color").hide(),
            t.css({
              "min-width": "210px"
            }))
          },
          click: function(t) {
            ...
            if ("cp" === n ? t.stopPropagation() : "cpbackColor" === n ? n = r : "cpforeColor" === n && (n = i),
            o && n) {
              ...
              a.css(s, n),
              l.attr("data-" + o, n),
              "fore" === d ? c.itemClick("foreColor", n) : "back" === d ? c.itemClick("backColor", n) : c.itemClick(o, n)
            }
          }
        })]
      }).render()
  ...
  var T, I = navigator.userAgent, N = /MSIE|Trident/i.test(I);
  if (N) {
    var E = /MSIE (\d+[.]\d+)/.exec(I);
    E && (T = parseFloat(E[1])),
    (E = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(I)) && (T = parseFloat(E[1]))
  }
  var A = /Edge\/\d+/.test(I)
    , F = !!window.CodeMirror;
  if (!F && S)
  ...
  var R = "ontouchstart"in window || 0 < navigator.MaxTouchPoints || 0 < navigator.msMaxTouchPoints
  ...
  var j = {
    ...
    clusterBy: function(t, n) {
      return t.length ? M(t).reduce(function(t, e) {
        var o = z(t);
        return n(z(o), e) ? o[o.length] = e : t[t.length] = [e],
        t
      }, [[B(t)]]) : []
    },
    compact: function(t) {
  ...
  function ut(t) {
    var e = dt(t);
    return 0 === e || (!G(t) && 1 === e && t.innerHTML === ct || !(!j.all(t.childNodes, G) || "" !== t.innerHTML))
  }
  function ht(t) {
  ...
  function $t(t, e) {
    ...
    if (0 === t.offset) {
      ...
      n = St(t.node) ? dt(o = t.node.childNodes[t.offset - 1]) : (o = t.node,
      e ? 0 : t.offset - 1);
    return {
      node: o,
      offset: n
  ...
  function Tt(t, e) {
    ...
    if (dt(t.node) === t.offset) {
      ...
      n = St(t.node) ? (o = t.node.childNodes[t.offset],
      0) : (o = t.node,
      e ? dt(t.node) : t.offset + 1);
    return {
      node: o,
      offset: n
    }
  ...
  function Nt(t, e) {
    ...
    o || (ht(t.node),
    ht(s)),
    i && (ut(t.node) && Ft(t.node),
    ut(s)) ? (Ft(s),
    t.node.nextSibling) : s
  }
  function Et(t, o, n) {
    var e = ft(o.node, D.eq(t));
    return e.length ? 1 === e.length ? Nt(o, n) : e.reduce(function(t, e) {
      return t === o.node && (t = Nt(o, n)),
      Nt({
        node: e,
        offset: t ? xt(t) : dt(e)
      }, n)
  ...
  var Lt = {
    ...
    isVisiblePoint: function(t) {
      if (G(t.node) || !St(t.node) || ut(t.node))
        return !0;
    ...
    splitPoint: function(t, e) {
      var o, n, i = e ? Z : st, r = ft(t.node, i), s = j.last(r) || t.node;
  ...
  function Ht(t, e) {
    var o, n, i = t.parentElement(), r = document.body.createTextRange(), s = j.from(i.childNodes);
    ...
    if (0 !== o && Lt.isText(s[o - 1])) {
      ...
      for (var d = c.text.replace(/[\r\n]/g, "").length; d > l.nodeValue.length && l.nextSibling; )
        ...
        l = l.nextSibling;
      l.nodeValue;
      e && l.nextSibling && Lt.isText(l.nextSibling) && d === l.nodeValue.length && (d -= l.nodeValue.length,
      l = l.nextSibling),
      i = l,
      o = d
    }
  ...
  var Bt = function() {
    ...
    return r.prototype.nativeRange = function() {
      ...
      return e.setEndPoint("EndToEnd", Dt({
        node: this.ec,
        offset: this.eo
      })),
      e
    ...
    r.prototype.normalize = function() {
      var t = function(t, e) {
        if (Lt.isVisiblePoint(t) && !Lt.isEdgePoint(t) || Lt.isVisiblePoint(t) && Lt.isRightEdgePoint(t) && !e || Lt.isVisiblePoint(t) && Lt.isLeftEdgePoint(t) && e || Lt.isVisiblePoint(t) && Lt.isBlock(t.node) && Lt.isEmpty(t.node))
          return t;
    ...
    r.prototype.nodes = function(o, t) {
      ...
      return Lt.walkPoint(e, r, function(t) {
        var e;
        Lt.isEditable(t.node) || (i ? (Lt.isLeftEdgePoint(t) && a.push(t.node),
        Lt.isRightEdgePoint(t) && j.contains(a, t.node) && (e = t.node)) : e = n ? Lt.ancestor(t.node, o) : t.node,
        e && o(e) && s.push(e))
      }, !0),
      j.unique(s)
    }
    ...
    r.prototype.splitText = function() {
      var t = this.sc === this.ec
        , e = this.getPoints();
      return Lt.isText(this.ec) && !Lt.isEdgePoint(this.getEndPoint()) && this.ec.splitText(this.eo),
      Lt.isText(this.sc) && !Lt.isEdgePoint(this.getStartPoint()) && (e.sc = this.sc.splitText(this.so),
      e.so = 0,
      t && (e.ec = e.sc,
    ...
    r.prototype.isLeftEdgeOf = function(t) {
      if (!Lt.isLeftEdgePoint(this.getStartPoint()))
        return !1;
      var e = Lt.ancestor(this.sc, t);
    ...
    r.prototype.wrapBodyInlineWithPara = function() {
      if (Lt.isBodyContainer(this.sc) && Lt.isEmpty(this.sc))
        return this.sc.innerHTML = Lt.emptyPara,
    ...
    createFromSelection: function() {
      ...
      if (L.isW3CRangeSupport) {
        ...
        var c = Ht(l, !0)
          , d = Ht(a, !1);
        Lt.isText(c.node) && Lt.isLeftEdgePoint(c) && Lt.isTextNode(d.node) && Lt.isRightEdgePoint(d) && d.node.nextSibling === c.node && (c = d),
        t = c.cont,
        e = c.offset,
        o = d.cont,
        n = d.offset
    ...
    createFromNode: function(t) {
      var e = t
        ...
        , n = t
        , i = Lt.nodeLength(n);
      return Lt.isVoid(e) && (o = Lt.listPrev(e).length - 1,
      e = e.parentNode),
      Lt.isBR(n) ? (i = Lt.listPrev(n).length - 1,
      n = n.parentNode) : Lt.isVoid(n) && (i = Lt.listPrev(n).length,
      n = n.parentNode),
      this.create(e, o, n, i)
    },
  ...
  var Mt = function() {
    ...
    t.prototype.applySnapshot = function(t) {
      ...
      null !== t.bookmark && zt.createFromBookmark(this.editable, t.bookmark).select()
    }
    ,
    ...
    t.prototype.styleNodes = function(t, e) {
      ...
      if (t.isCollapsed())
        return [t.insertNode(Lt.create(o))];
    ...
    t.prototype.current = function(t) {
      ...
      return o.anchor = t.isOnAnchor() && Lt.ancestor(t.sc, Lt.isAnchor),
    ...
    t.prototype.outdent = function(t) {
      ...
      k.each(i, function(t, e) {
        var o = j.head(e);
        Lt.isLi(o) ? n.releaseList([e]) : k.each(e, function(t, e) {
          k(e).css("marginLeft", function(t, e) {
    ...
    t.prototype.wrapList = function(t, e) {
      ...
      r && (Lt.appendChildNodes(s, j.from(r.childNodes)),
      Lt.remove(r)),
      t
    }
    ,
    t.prototype.releaseList = function(t, c) {
      ...
      return k.each(t, function(t, e) {
        ...
        if ("LI" === i.parentNode.nodeName)
          ...
          e = c ? Lt.listDescendant(a, Lt.isLi) : j.from(a.childNodes).filter(Lt.isLi),
          !c && Lt.isList(i.parentNode) || (e = e.map(function(t) {
    ...
    t.prototype.findList = function(t) {
      return t ? j.find(t.children, function(t) {
    ...
    t.prototype.insertParagraph = function(t, e) {
      e = (e = (e = e || zt.create(t)).deleteContents()).wrapBodyInlineWithPara();
      var o, n = Lt.ancestor(e.sc, Lt.isPara);
      if (n) {
        if (Lt.isEmpty(n) && Lt.isLi(n))
          return void this.bullet.toggleList(n.parentNode.nodeName);
        var i = null;
        if (1 === this.options.blockquoteBreakingLevel ? i = Lt.ancestor(n, Lt.isBlockquote) : 2 === this.options.blockquoteBreakingLevel && (i = Lt.lastAncestor(n, Lt.isBlockquote)),
        i) {
          o = k(Lt.emptyPara)[0],
          Lt.isRightEdgePoint(e.getStartPoint()) && Lt.isBR(e.sc.nextSibling) && k(e.sc.nextSibling).remove();
    ...
    function C(t) {
      ...
      case qt.where.Column:
        if (t.isColSpan)
          return qt.resultAction.SumSpanCount;
    ...
    this.getActionList = function() {
      for (var t, e, o, n = h === qt.where.Row ? f.rowPos : -1, i = h === qt.where.Column ? f.colPos : -1, r = 0, s = !0; s; ) {
        var a = 0 <= n ? n : r
          , l = 0 <= i ? i : r
          , c = m[a];
        if (!c)
  ...
  var Kt, Vt = function() {
    ...
    t.prototype.addRow = function(t, e) {
      for (var o = Lt.ancestor(t.commonAncestor(), Lt.isCell), n = k(o).closest("tr"), i = this.recoverAttributes(n), r = k("<tr" + i + "></tr>"), s = new qt(o,qt.where.Row,qt.requestAction.Add,k(n).closest("table")[0]).getActionList(), a = 0; a < s.length; a++) {
        var l = s[a]
        ...
        case qt.resultAction.SumSpanCount:
          if ("top" === e)
            if ((l.baseCell.parent ? l.baseCell.closest("tr").rowIndex : 0) <= n[0].rowIndex) {
              var d = k("<div></div>").append(k("<td" + c + ">" + Lt.blank + "</td>").removeAttr("rowspan")).html();
              r.append(d);
              break
            }
    ...
    t.prototype.addCol = function(t, e) {
      var o = Lt.ancestor(t.commonAncestor(), Lt.isCell)
        , n = k(o).closest("tr");
      k(n).siblings().push(n);
      for (var i = new qt(o,qt.where.Column,qt.requestAction.Add,k(n).closest("table")[0]).getActionList(), r = 0; r < i.length; r++) {
        var s = i[r]
          , a = this.recoverAttributes(s.baseCell);
        switch (s.action) {
        case qt.resultAction.AddCell:
          "right" === e ? k(s.baseCell).after("<td" + a + ">" + Lt.blank + "</td>") : k(s.baseCell).before("<td" + a + ">" + Lt.blank + "</td>");
          break;
        case qt.resultAction.SumSpanCount:
          if ("right" === e) {
    ...
    t.prototype.deleteRow = function(t) {
      for (var e = Lt.ancestor(t.commonAncestor(), Lt.isCell), o = k(e).closest("tr"), n = o.children("td, th").index(k(e)), i = o[0].rowIndex, r = new qt(e,qt.where.Row,qt.requestAction.Delete,k(o).closest("table")[0]).getActionList(), s = 0; s < r.length; s++)
        if (r[s]) {
          var a = r[s].baseCell
            , l = r[s].virtualTable
    ...
    t.prototype.deleteCol = function(t) {
      for (var e = Lt.ancestor(t.commonAncestor(), Lt.isCell), o = k(e).closest("tr"), n = o.children("td, th").index(k(e)), i = new qt(e,qt.where.Column,qt.requestAction.Delete,k(o).closest("table")[0]).getActionList(), r = 0; r < i.length; r++)
        if (i[r])
          switch (i[r].action) {
          case qt.resultAction.Ignore:
            continue;
    ...
    return t.prototype.initialize = function() {
      ...
      this.$editable.on("keydown", function(t) {
        if (t.keyCode === K.code.ENTER && e.context.triggerEvent("enter", t),
      ...
      this.$editable.on(L.inputEventName, D.debounce(function() {
    ...
    t.prototype.handleKeyMap = function(t) {
      ...
      n && o.push(n);
      var i = e[o.join("+")];
      i ? !1 !== this.context.invoke(i) && t.preventDefault() : K.isEdit(t.keyCode) && this.afterCommand()
    }
    ,
    t.prototype.preventDefaultEditableShortCuts = function(t) {
      (t.ctrlKey || t.metaKey) && j.contains([66, 73, 85], t.keyCode) && t.preventDefault()
    }
    ,
    t.prototype.isLimited = function(t, e) {
      return t = t || 0,
      (void 0 === e || !(K.isMove(e.keyCode) || e.ctrlKey || e.metaKey || j.contains([K.code.BACKSPACE, K.code.DELETE], e.keyCode))) && (0 < this.options.maxTextLength && this.$editable.text().length + t >= this.options.maxTextLength)
    }
    ,
    t.prototype.createRange = function() {
      return this.focus(),
      zt.create(this.editable)
    }
    ,
    ...
    t.prototype.getSelectedText = function() {
      var t = this.createRange();
      return t.isOnAnchor() && (t = zt.createFromNode(Lt.ancestor(t.sc, Lt.isAnchor))),
      t.toString()
    }
    ,
    ...
    t.prototype.fontStyling = function(t, e) {
      ...
      if (o) {
        ...
        o.isCollapsed()) {
          var i = j.head(n);
          i && !Lt.nodeLength(i) && (i.innerHTML = Lt.ZERO_WIDTH_NBSP_CHAR,
  ...
  var Yt = function() {
    ...
    t.prototype.activate = function() {
      var e = this;
      if (this.$codable.val(Lt.html(this.$editable, this.options.prettifyHtml)),
    ...
    t.prototype.deactivate = function() {
      ...
      var e = Lt.value(this.$codable, this.options.prettifyHtml) || Lt.emptyPara
    ...
    function t(t) {
      ...
      this.options = t.options,
      this.lang = this.options.langInfo,
      this.invertedKeyMap = D.invertObject(this.options.keyMap[L.isMac ? "mac" : "pc"])
    }
    return t.prototype.representShortcut = function(t) {
      var e = this.invertedKeyMap[t];
      return this.options.shortcuts && e ? (L.isMac && (e = e.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")),
    ...
    t.prototype.isFontInstalled = function(t) {
      return this.fontInstalledMap.hasOwnProperty(t) || (this.fontInstalledMap[t] = L.isFontInstalled(t) || j.contains(this.options.fontNamesIgnoreCheck, t)),
    ...
    t.prototype.bindEnterKey = function(t, e) {
      t.on("keypress", function(t) {
        t.keyCode === K.code.ENTER && (t.preventDefault(),
        e.trigger("click"))
      })
    }
    ,
    ...
    function t(t) {
      ...
      this.events = {
        ...
        "summernote.focusout": function(t, e) {
          L.isFF || e.relatedTarget && Lt.ancestor(e.relatedTarget, D.eq(o.$popover[0])) || o.hide()
        }
      }
    }
    return t.prototype.shouldInitialize = function() {
    ...
    t.prototype.nodeFromItem = function(t) {
      ...
      return "string" == typeof n && (n = Lt.createText(n)),
      n
    }
    ,
    ...
    ,
    t.prototype.handleKeydown = function(t) {
      this.$popover.is(":visible") && (t.keyCode === K.code.ENTER ? (t.preventDefault(),
      this.replace()) : t.keyCode === K.code.UP ? (t.preventDefault(),
      this.moveUp()) : t.keyCode === K.code.DOWN && (t.preventDefault(),
      this.moveDown()))
    }
    ,
    ...
    t.prototype.removeModule = function(t) {
      var e = this.modules[t];
      e.shouldInitialize() && (e.events && Lt.detachEvents(this.$note, e.events),
      e.destroy && e.destroy()),
  ...
  k.fn.extend({
    summernote: function() {
      ...
      if (n.length) {
        ...
        if (e)
          return r.invoke.apply(r, j.from(arguments));
